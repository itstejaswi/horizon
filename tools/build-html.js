...
const brand = `  <!-- The Horizon mark: a solid world with an open orbital arc sweeping
  ...
  <!-- Same geometry, marginally heavier, for 24px and below. The smaller
       sparkle is dropped here: below 24px it fills in and reads as a smudge
       beside the larger one rather than as a second star. -->
